...
class WCMp_Order {
    ...
    public function __construct() {
        ...
        if (is_wcmp_version_less_3_4_0()) {
            ...
            add_action( 'woocommerce_subscription_renewal_payment_failed', array(&$this, 'woocommerce_subscription_renewal_payment_failed_suborder'), 10, 2);
        }
    }
...
//                        }
    ...
    public function woocommerce_subscription_renewal_payment_failed_suborder($subscription, $order) {
        $this->wcmp_manually_create_order_item_and_suborder($order->get_id(), '', true);
    }
}
